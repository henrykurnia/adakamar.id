                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="number" name="quantity" id="quantity"
                                    ...
                                    placeholder="Masukkan jumlah" value="{{ old('quantity') }}" required min="1">
                                @error('quantity')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
...
@push('scripts')
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Fungsi untuk menentukan efek stok (selalu 0 karena Pending)
        function getStockEffect(type) {
            // Karena status selalu Pending, stok TIDAK akan berubah
            return '0';
        }
                    ...
                    <div class="text-left">
                        <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                            ...
                            <p class="text-gray-500 text-xs mt-1">
                                ℹ️ Hanya Manager Gudang yang dapat membuat transaksi, dan Staff Gudang yang menyetujui
                            </p>
                        </div>
                    </div>
                `,
