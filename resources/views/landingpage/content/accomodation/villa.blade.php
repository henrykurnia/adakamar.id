...
@section('content')
    ...
    <!-- Daftar Villa -->
    <section id="daftar-villa" class="py-20 bg-white dark:bg-gray-800">
        <div class="container mx-auto px-4">
            ...
            <div class="mb-8">
                <nav class="flex text-sm text-[#666666] dark:text-gray-400 mb-4">
                    ...
                    <span class="text-[#E60000] font-semibold">Daftar Villa</span>
                </nav>
                <div class="text-center mb-8">
                    <h1 class="text-3xl md:text-4xl font-bold text-[#E60000] dark:text-[#FF6B6B] mb-3">Daftar Villa</h1>
                    <p class="text-lg text-[#666666] dark:text-gray-400">Pilih villa yang sesuai dengan kebutuhan dan budget
                        Anda</p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                <div
                    ...
                    <div class="p-5">
                        ...
                        <p class="text-[#666666] dark:text-gray-400 text-sm mb-2">Villa Resort • Bali</p>
                ...
                <div
                    class="bg-white dark:bg-gray-700 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-[#F2F2F2] dark:border-gray-600">
                    <div class="relative overflow-hidden">
                        <img src="{{ asset('landingpage/villa.jpg') }}" alt="Villa Premium"
                            class="w-full h-56 object-cover hover:scale-110 transition-transform duration-500">
                        <span
                            class="absolute top-3 right-3 bg-green-500 text-white px-3 py-1 rounded-full text-xs font-semibold flex items-center gap-1">
                            <span class="w-1.5 h-1.5 bg-white rounded-full"></span>
                    ...
                    <div class="p-5">
                        <h3 class="font-bold text-[#333333] dark:text-white text-lg mb-1">Villa Premium</h3>
                ...
                <div
                    ...
                    <div class="relative overflow-hidden">
                        <img src="{{ asset('landingpage/villa.jpg') }}" alt="Villa Standard"
                    ...
                    <div class="p-5">
                        <h3 class="font-bold text-[#333333] dark:text-white text-lg mb-1">Villa Standard</h3>
                        <p class="text-[#666666] dark:text-gray-400 text-sm mb-2">Villa Garden • Bandung</p>
                        <div class="flex items-center justify-between mb-3">
                            <div>
                                <span class="text-[#E60000] font-bold text-xl">Rp 500.000</span>
                                <span class="text-[#666666] dark:text-gray-400 text-xs">/malam</span>
                            </div>
                        </div>
                        <a href="#"
                ...
                <div
                    class="bg-white dark:bg-gray-700 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-[#F2F2F2] dark:border-gray-600">
                    <div class="relative overflow-hidden">
                        <img src="{{ asset('landingpage/villa.jpg') }}" alt="Villa Eksekutif"
                            class="w-full h-56 object-cover hover:scale-110 transition-transform duration-500">
                        <span
                            class="absolute top-3 right-3 bg-green-500 text-white px-3 py-1 rounded-full text-xs font-semibold flex items-center gap-1">
                            <span class="w-1.5 h-1.5 bg-white rounded-full"></span>
                    ...
                    <div class="p-5">
                        <h3 class="font-bold text-[#333333] dark:text-white text-lg mb-1">Villa Eksekutif</h3>
                        <p class="text-[#666666] dark:text-gray-400 text-sm mb-2">Villa Resort • Surabaya</p>
                        <div class="flex items-center justify-between mb-3">
                            <div>
                                <span class="text-[#E60000] font-bold text-xl">Rp 950.000</span>
                                <span class="text-[#666666] dark:text-gray-400 text-xs">/malam</span>
                            </div>
                        </div>
                        <a href="#"
                ...
                <div
                    class="bg-white dark:bg-gray-700 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-[#F2F2F2] dark:border-gray-600">
                    <div class="relative overflow-hidden">
                        <img src="{{ asset('landingpage/villa.jpg') }}" alt="Villa Deluxe"
                            class="w-full h-56 object-cover hover:scale-110 transition-transform duration-500">
                        <span
                            class="absolute top-3 right-3 bg-green-500 text-white px-3 py-1 rounded-full text-xs font-semibold flex items-center gap-1">
                            <span class="w-1.5 h-1.5 bg-white rounded-full"></span>
                    ...
                    <div class="p-5">
                        <h3 class="font-bold text-[#333333] dark:text-white text-lg mb-1">Villa Deluxe</h3>
                        <p class="text-[#666666] dark:text-gray-400 text-sm mb-2">Villa Premium • Yogyakarta</p>
                        <div class="flex items-center justify-between mb-3">
                            <div>
                                <span class="text-[#E60000] font-bold text-xl">Rp 750.000</span>
                                <span class="text-[#666666] dark:text-gray-400 text-xs">/malam</span>
                            </div>
                        </div>
                        <a href="#"
                ...
                <div
                    class="bg-white dark:bg-gray-700 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-[#F2F2F2] dark:border-gray-600 opacity-75">
                    <div class="relative overflow-hidden">
                        <img src="{{ asset('landingpage/villa.jpg') }}" alt="Villa Ekonomis"
                            class="w-full h-56 object-cover hover:scale-110 transition-transform duration-500 grayscale">
                        <span
                            class="absolute top-3 right-3 bg-red-500 text-white px-3 py-1 rounded-full text-xs font-semibold flex items-center gap-1">
                            <span class="w-1.5 h-1.5 bg-white rounded-full"></span>
                    ...
                    <div class="p-5">
                        <h3 class="font-bold text-[#333333] dark:text-white text-lg mb-1">Villa Ekonomis</h3>
                        <p class="text-[#666666] dark:text-gray-400 text-sm mb-2">Villa Sederhana • Malang</p>
                        <div class="flex items-center justify-between mb-3">
                            <div>
            ...
            <div class="text-center mt-6 text-sm text-[#666666] dark:text-gray-400">
                Menampilkan 4 dari 6 villa tersedia
            </div>
        </div>
    </section>
