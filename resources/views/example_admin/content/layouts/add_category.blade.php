            ...
            <div class="col-span-full">
                <div
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name') }}"
                            class="shadow-sm bg-[#F5F0FF] border border-[#E8D5F5] text-gray-900 sm:text-sm rounded-lg
                                        ...
                                        dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-[#3874FF] dark:focus:border-[#3874FF]" placeholder="Masukkan nama kategori"
                            required>
                        @error('name')
                    ...
                    <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 mt-6">
                        <button type="submit" id="submitBtn" class="text-white bg-[#1B4EF5] hover:bg-[#3874FF] focus:ring-4
                            ...
                            <span id="submitText">Tambahkan Kategori</span>
                        ...
                        <a href="{{ route('admin.categories.index') }}" class="text-gray-900 bg-white border border-gray-300
                                        focus:outline-none hover:bg-gray-100 hover:text-[#1B4EF5] focus:ring-4 focus:ring-[#D4E0FF]
            ...
            form.addEventListener('submit', function (e) {
                ...
                if (!namePattern.test(nameValue)) {
                    ...
                    Swal.fire({
                        icon: 'warning',
                        title: 'Perhatian!',
                        text: 'Nama kategori hanya boleh mengandung huruf, angka, spasi, garis bawah, dan tanda hubung',
                        confirmButtonColor: '#1B4EF5',
                        confirmButtonText: 'OK'
                    });
                    nameInput.focus();
