...
@section('content')
    <div class="grid grid-cols-1 px-4 pt-6 xl:gap-4 dark:bg-gray-900">
        <div class="mb-4 col-span-full xl:mb-2">
            <h1 class="text-xl font-semibold text-[#1B4EF5] sm:text-2xl dark:text-[#3874FF]">Edit Produk</h1>
        </div>
        ...
        <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-span-full">
                <div
                    ...
                    <!-- Upload Foto Section -->
                    <div
                        class="flex flex-col sm:flex-row items-center sm:items-start xl:items-center gap-4 sm:gap-6 pb-6 mb-6 border-b border-[#E8D5F5] dark:border-gray-700">
                        <div class="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 w-full sm:w-auto">
                            ...
                            <div class="flex flex-col items-center sm:items-start w-full sm:w-auto">
                                <label
                                    class="cursor-pointer px-4 py-2 bg-[#1B4EF5] text-white rounded-lg hover:bg-[#3874FF] focus:ring-4 focus:ring-[#D4E0FF] dark:bg-[#3874FF] dark:hover:bg-[#1B4EF5] dark:focus:ring-[#5996FF] inline-flex items-center w-full sm:w-auto justify-center">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                            ...
                            <div class="col-span-1">
                                <label for="purchase_price"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Harga Beli <span
                                        class="text-red-500">*</span></label>
                                <input type="number" name="purchase_price" id="purchase_price"
                                    class="shadow-sm bg-[#F5F0FF] border border-[#E8D5F5] text-gray-900 sm:text-sm rounded-lg focus:ring-[#1B4EF5] focus:border-[#1B4EF5] block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-[#3874FF] dark:focus:border-[#3874FF]"
                                    placeholder="750000" value="{{ old('purchase_price', $product->purchase_price) }}"
                                    required>
                            ...
                            <div class="col-span-1">
                                <label for="selling_price"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Harga Jual <span
                                        class="text-red-500">*</span></label>
                                <input type="number" name="selling_price" id="selling_price"
                                    class="shadow-sm bg-[#F5F0FF] border border-[#E8D5F5] text-gray-900 sm:text-sm rounded-lg focus:ring-[#1B4EF5] focus:border-[#1B4EF5] block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-[#3874FF] dark:focus:border-[#3874FF]"
                                    placeholder="850000" value="{{ old('selling_price', $product->selling_price) }}"
                                    required>
                                @error('selling_price')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="col-span-1">
                                <label for="minimum_stock"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Stok Minimal <span
                                        class="text-red-500">*</span></label>
                            ...
                            <!-- Tombol Submit -->
                            <div
                                class="col-span-1 sm:col-span-2 lg:col-span-3 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 mt-4">
                                <button type="submit"
                                    class="inline-flex items-center justify-center px-5 py-2.5 text-sm font-medium text-white bg-[#1B4EF5] rounded-lg hover:bg-[#3874FF] focus:ring-4 focus:ring-[#D4E0FF] dark:bg-[#3874FF] dark:hover:bg-[#1B4EF5] dark:focus:ring-[#5996FF] w-full sm:w-auto">
