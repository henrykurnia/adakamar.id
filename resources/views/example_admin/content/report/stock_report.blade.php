...
@section('content')
        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-0">
            ...
            <div class="flex items-center w-full sm:w-auto">
                <form class="w-full sm:w-auto" action="{{ route('admin.reports.stock') }}" method="GET" id="searchForm">
                    <div class="flex items-center gap-2">
                        <div class="relative flex-1 sm:w-64 xl:w-96">
                ...
                @if(request('keyword') || request('category'))
                    <a href="{{ route('admin.reports.stock') }}"
                        class="text-sm text-[#1B4EF5] hover:text-[#3874FF] dark:text-[#3874FF] dark:hover:text-[#5996FF] ml-2 whitespace-nowrap">
            ...
            <div class="flex items-center gap-2 w-full sm:w-auto">
                <!-- Filter Kategori -->
                <form action="{{ route('admin.reports.stock') }}" method="GET" class="flex items-center gap-3" id="filterForm">
                    @if(request('keyword'))
                        <input type="hidden" name="keyword" value="{{ request('keyword') }}">
                    @endif

                    <select id="category-filter" name="category" onchange="this.form.submit()"
                        class="bg-[#F5F0FF] border border-[#E8D5F5] text-gray-900 text-xs rounded-lg focus:ring-[#1B4EF5] focus:border-[#1B4EF5] block py-2 px-3 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-[#3874FF] dark:focus:border-[#3874FF] h-[38px] w-[140px]">
                    ...
                    <!-- Tombol Export Excel -->
                    <button type="button"
                        class="inline-flex items-center justify-center px-3 py-2 text-xs font-medium text-white bg-green-600 rounded-lg hover:bg-green-700 focus:ring-4 focus:ring-green-300 dark:bg-green-500 dark:hover:bg-green-600 dark:focus:ring-green-800 transition-all duration-200 h-[38px] w-[140px] whitespace-nowrap"
                        id="exportButton">
        ...
        <form id="exportForm" action="{{ route('admin.reports.stock.export') }}" method="GET" target="_blank">
            <input type="hidden" name="keyword" value="{{ request('keyword') }}">
