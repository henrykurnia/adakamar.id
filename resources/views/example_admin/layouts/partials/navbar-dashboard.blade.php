    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center justify-start">
        ...
        <a href="{{ url('/') }}" class="flex ml-2 md:mr-24">
          <img src="{{ asset('static/images/stockify.png')}}" class="h-8 mr-3" alt="Stockify Logo" />
          <span
      ...
      <div class="flex items-center">
        ...
        <div
          ...
          <a href="#"
            class="block py-2 text-base font-normal text-center text-gray-900 bg-gray-50 hover:bg-[#F5F0FF] dark:bg-gray-700 dark:text-white dark:hover:underline">
